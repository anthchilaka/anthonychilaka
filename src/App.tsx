...
import portfolioloading from './assets/images/portfolioloading.png'
import sourcing from './assets/images/sourcing.png'
import training from './assets/images/training.png'
import voiceover from './assets/images/voiceover.png'
import webbuild from './assets/images/webbuild.png'
import walkthrough from './assets/images/walkthrough.png'
import walkthroughloading from './assets/images/walkthroughloading.png'

// 4. Import Template Images
import businesstemplate from './assets/images/businesstemplate.png'
import financetemplate from './assets/images/financetemplate.png'
import restauranttemplate from './assets/images/restauranttemplate.png'
import beautyandfashion from './assets/images/beautyandfashion.png'
import ngoservices from './assets/images/ngoservices.png'
import enterprise from './assets/images/enterprise.png'

// 5. Import Voice Over Images
import fireImg from './assets/images/fire.png'
import hangImg from './assets/images/hang.png'
import giverImg from './assets/images/giver.png'
import daddyImg from './assets/images/daddy.png'
    ...
    <div className="portfolio-container min-h-screen bg-white text-[#0F0F0F] font-body flex flex-col relative">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-5 items-center">
            <div className="hidden md:flex gap-4 items-center border-r border-gray-200 pr-5">
              ...
              <a href="https://x.com/anthonychilaka" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
            ...
            <a href="https://cal.com/anthonychilaka" target="_blank" rel="noopener noreferrer" 
               className="bg-[#0F0F0F] hover:bg-[#C41E3A] text-white px-6 py-2.5 rounded text-sm font-heading font-semibold transition-colors duration-300">
              Book Now
            </a>
          </div>
        </div>
      ...
      {currentView === 'home' && (
        <main className="flex-grow">
          <header id="home" className="hero-viewport relative flex items-center justify-center text-center text-white scroll-mt-20">
            <img src={banner} alt="Banner" className="absolute inset-0 w-full h-full object-cover z-0 brightness-50" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition overflow-hidden border border-gray-100">
                  <a href="https://cal.com/anthonychilaka" target="_blank" rel="noopener noreferrer" className="block h-48 overflow-hidden group cursor-pointer" title="click for more">
                    <img src={analytics} alt="Business Analytics" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                  </a>
                  <div className="p-6">
                ...
                <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition overflow-hidden border border-gray-100">
                  <a href="https://wa.me/2347015366600?text=Hi%20Anthony,%20I%20have%20viewed%20your%20services%20and%20would%20like%20to%20discuss%20further" target="_blank" rel="noopener noreferrer" className="block h-48 overflow-hidden group cursor-pointer" title="click for more">
                    <img src={training} alt="BI Training" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                  </a>
                  <div className="p-6">
                ...
                <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition overflow-hidden border border-gray-100">
                  <a href="https://cal.com/anthonychilaka" target="_blank" rel="noopener noreferrer" className="block h-48 overflow-hidden group cursor-pointer" title="click for more">
                    <img src={sourcing} alt="Corporate Sourcing" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                  </a>
                  <div className="p-6">
                ...
                <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition overflow-hidden border border-gray-100">
                  <a href="#" 
                    ...
                    <img src={voiceover} alt="Voice Over" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                  </a>
                  <div className="p-6">
                ...
                <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition overflow-hidden border border-gray-100">
                  <a href="#" 
                     ...
                     className="block h-48 overflow-hidden group cursor-pointer" title="click for more">
                    <img src={webbuild} alt="Website Development" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                  </a>
                  <div className="p-6">
                ...
                <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition overflow-hidden border border-gray-100">
                  <a href="#" 
                    ...
                    <img src={walkthrough} alt="Monthly Project Walkthroughs" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                  </a>
                  <div className="p-6">
          ...
          <section id="portfolio" className="py-24 bg-white scroll-mt-10">
            <div className="max-w-7xl mx-auto px-6 text-center">
              ...
              <a href="#" 
                ...
                <img src={portfolio} alt="Portfolio Header" className="w-full h-auto loading-lazy transition-transform duration-500 group-hover:scale-105" />
              </a>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-gray-50 rounded-xl overflow-hidden p-5 flex flex-col items-center border border-gray-100">
                <a href="https://wpastra.com/website-templates/business/" target="_blank" rel="noopener noreferrer" className="w-full h-56 rounded-md overflow-hidden group shadow-sm block cursor-pointer">
                  <img src={businesstemplate} alt="Business Template" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                </a>
              ...
              <div className="bg-gray-50 rounded-xl overflow-hidden p-5 flex flex-col items-center border border-gray-100">
                <a href="https://wpastra.com/website-templates/finance/" target="_blank" rel="noopener noreferrer" className="w-full h-56 rounded-md overflow-hidden group shadow-sm block cursor-pointer">
                  <img src={financetemplate} alt="Finance Template" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                </a>
              ...
              <div className="bg-gray-50 rounded-xl overflow-hidden p-5 flex flex-col items-center border border-gray-100">
                <a href="https://wpastra.com/website-templates/restaurant/" target="_blank" rel="noopener noreferrer" className="w-full h-56 rounded-md overflow-hidden group shadow-sm block cursor-pointer">
                  <img src={restauranttemplate} alt="Restaurant Template" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                </a>
              ...
              <div className="bg-gray-50 rounded-xl overflow-hidden p-5 flex flex-col items-center border border-gray-100">
                <a href="https://wpastra.com/website-templates/beauty-fashion/" target="_blank" rel="noopener noreferrer" className="w-full h-56 rounded-md overflow-hidden group shadow-sm block cursor-pointer">
                  <img src={beautyandfashion} alt="Beauty and Fashion" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                </a>
              ...
              <div className="bg-gray-50 rounded-xl overflow-hidden p-5 flex flex-col items-center border border-gray-100">
                <a href="https://wpastra.com/website-templates/service/" target="_blank" rel="noopener noreferrer" className="w-full h-56 rounded-md overflow-hidden group shadow-sm block cursor-pointer">
                  <img src={ngoservices} alt="NGO/Services" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                </a>
              ...
              <div className="bg-gray-50 rounded-xl overflow-hidden p-5 flex flex-col items-center border border-gray-100">
                <a href="https://wa.me/2347015366600?text=Hi%20Anthony,%20I%20have%20viewed%20your%20services%20and%20would%20like%20to%20discuss%20further" target="_blank" rel="noopener noreferrer" className="w-full h-56 rounded-md overflow-hidden group shadow-sm block cursor-pointer">
                  <img src={enterprise} alt="Enterprise Solution" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                </a>
              ...
              {VOICEOVERS_DATA.map((vo) => (
                ...
                >
                  <div className="h-64 overflow-hidden relative">
                    <img src={vo.imageSrc} alt={vo.header} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="flex justify-center mt-10">
              <div className="max-w-3xl w-full rounded-2xl overflow-hidden shadow-xl border border-gray-100">
                <img src={walkthroughloading} alt="Walkthroughs Loading" className="w-full h-auto object-cover" />
              </div>
            </div>
          </div>
        </main>
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="flex justify-center mt-10">
              <div className="max-w-4xl w-full rounded-2xl overflow-hidden shadow-xl border border-gray-100">
                <img src={portfolioloading} alt="Portfolio Content Loading" className="w-full h-auto object-cover" />
              </div>
            </div>
          </div>
        </main>
      ...
      <footer id="contact" className="py-20 bg-[#1B3022] text-white overflow-hidden scroll-mt-10 mt-auto">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex gap-6">
              <a href="https://www.linkedin.com/in/anthonychilaka/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform bg-white/10 hover:bg-white/20 p-3 rounded-full">
                <img src={linkedin} alt="LinkedIn" className="w-5 h-5 opacity-90" />
              </a>
              <a href="https://www.upwork.com/freelancers/~01952cdb9ce3e5b230?s=1017484851352698939" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform bg-white/10 hover:bg-white/20 p-3 rounded-full">
                <img src={upwork} alt="Upwork" className="w-5 h-5 opacity-90" />
              </a>
              <a href="https://x.com/anthonychilaka" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform bg-white/10 hover:bg-white/20 p-3 rounded-full">
                <img src={xIcon} alt="X" className="w-5 h-5 opacity-90" />
              </a>
              <a href="https://wa.me/2347015366600?text=Hi%20Anthony,%20I%20have%20viewed%20your%20services%20and%20would%20like%20to%20discuss%20further" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform bg-white/10 hover:bg-white/20 p-3 rounded-full flex items-center justify-center">
                <img src={whatsapp} alt="WhatsApp" className="w-5 h-5 opacity-90 scale-[2]" />
              </a>
            </div>
          </div>
          ...
          <div className="relative cursor-pointer overflow-hidden rounded-2xl group shadow-2xl" onClick={() => window.open('https://cal.com/anthonychilaka', '_blank')}>
            <img src={call} alt="Book a discovery call" className="loading-lazy brightness-75 group-hover:brightness-100 transition duration-500 w-full object-cover h-80" />
            <div className="absolute inset-0 flex items-center justify-center">
              {/* UPDATED CTA BUTTON WITH TRANSPARENCY AND NEW TEXT */}
